...
export default function SpotifyLogin() {
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* Footer */}
      <footer className="border-t border-white/[0.06] px-8 py-5 flex flex-wrap items-center justify-between gap-4 text-xs text-white/50">
        <div className="flex items-center gap-5">
          <span>made by{' '}
            <a href="https://jerankda.dev" target="_blank" rel="noreferrer" className="text-white font-medium hover:text-green-400 transition-colors">
              jerankda
            </a>
          </span>
          <a
        ...
        <span className="text-white/50">free &amp; open source</span>
      </footer>
